...
> Template. Replace bracketed/placeholder text. `build_report.py` injects `0.7394163995726496`, `0.09375`,
> `0.15789473684210525` from `research/outputs/metrics/metrics.json` and copies figures. Export to PDF for submission.
...
- **Classification:** AUC-ROC = 0.7394163995726496, Recall (churn) = 0.09375, F1 = 0.15789473684210525.
